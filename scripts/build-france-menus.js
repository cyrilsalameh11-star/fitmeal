...
// ============================== McDonald's France ==============================
// Per-portion values from McDonald's France public nutrition data.
const MCDO = [
  ['Hamburger',                    'burger',  255, 13, 32, 8,  ['beef','burger']],
  ['Cheeseburger',                 'burger',  302, 16, 33, 12, ['beef','cheese','burger']],
  ['Double Cheeseburger',          'burger',  442, 25, 33, 22, ['beef','cheese','burger']],
  ['Royal Cheese',                 'burger',  410, 22, 34, 19, ['beef','cheese','burger']],
  ['Royal Deluxe',                 'burger',  486, 24, 38, 25, ['beef','cheese','burger']],
  ['Royal Bacon',                  'burger',  515, 30, 35, 26, ['beef','cheese','burger']],
  ['Big Mac',                      'burger',  495, 26, 43, 23, ['beef','burger']],
  ['Big Tasty Bacon',              'burger',  720, 36, 47, 41, ['beef','cheese','burger']],
  ['McChicken',                    'burger',  395, 19, 41, 16, ['chicken','burger']],
  ['McChicken Bacon Premiere',     'burger',  555, 28, 47, 27, ['chicken','cheese','burger']],
  ['Filet-O-Fish',                 'burger',  338, 16, 36, 14, ['fish','burger']],
  ['CBO (Chicken Bacon Oignon)',   'burger',  552, 28, 49, 26, ['chicken','cheese','burger']],
  ['McFirst Poulet',               'burger',  330, 19, 32, 13, ['chicken','burger']],
  ['McWrap Sweet Chili Poulet',    'wrap',    430, 24, 51, 14, ['chicken','wrap']],
  ['McWrap Chicken Bacon',         'wrap',    485, 26, 47, 21, ['chicken','cheese','wrap']],
  ['McWrap Veggie',                'wrap',    410, 11, 53, 16, ['vegetarian','wrap']],
  ['Croque McDo',                  'sandwich',239, 15, 26, 8,  ['cheese']],
  ['McNuggets x4',                 'fried',   190, 13, 11, 11, ['chicken']],
  ['McNuggets x6',                 'fried',   285, 19, 16, 17, ['chicken']],
  ['McNuggets x9',                 'fried',   428, 28, 24, 25, ['chicken']],
  ['McNuggets x20',                'fried',   952, 63, 53, 56, ['chicken']],
  ['Chicken McFirst x4',           'fried',   240, 16, 14, 13, ['chicken']],
  ['Frites Petite',                'side',    230, 3,  29, 11, []],
  ['Frites Moyenne',               'side',    337, 4,  44, 16, []],
  ['Frites Grande',                'side',    444, 6,  57, 21, []],
  ['Potatoes',                     'side',    266, 5,  31, 14, []],
  ['Salade César Poulet Pané',     'salad',   256, 18, 11, 15, ['chicken','salad']],
  ['Salade Caesar Wrap Veggie',    'wrap',    373, 12, 47, 14, ['vegetarian','wrap']],
  ['Sundae Chocolat',              'dessert', 320, 7,  53, 9,  ['dessert']],
  ['Sundae Caramel',               'dessert', 326, 7,  56, 8,  ['dessert']],
  ['McFlurry Daim',                'dessert', 416, 8,  55, 18, ['dessert']],
  ['McFlurry Kit Kat',             'dessert', 405, 8,  55, 17, ['dessert']],
  ['McFlurry Smarties',            'dessert', 360, 8,  56, 12, ['dessert']],
  ['McFlurry Oreo',                'dessert', 366, 9,  56, 12, ['dessert']],
  ['Petit Cornet',                 'dessert', 138, 4,  20, 5,  ['dessert']],
  ['Cookie Chocolat',              'dessert', 195, 3,  26, 9,  ['dessert']],
  ['Donut Sucre',                  'dessert', 285, 4,  37, 13, ['dessert']],
  ['Macaron Vanille',              'dessert', 95,  1,  13, 4,  ['dessert']],
  ['Brownie',                      'dessert', 220, 3,  28, 11, ['dessert']],
  ['McCafé Cappuccino',            'drink',   90,  5,  9,  4,  []],
  ['McCafé Latte Macchiato',       'drink',   125, 7,  12, 5,  []],
  ['McCafé Chocolat Chaud',        'drink',   235, 8,  35, 7,  []],
  ['Milkshake Vanille (M)',        'drink',   349, 9,  62, 8,  ['dessert']],
  ['Milkshake Chocolat (M)',       'drink',   389, 10, 70, 9,  ['dessert']],
  ['Milkshake Fraise (M)',         'drink',   354, 9,  64, 8,  ['dessert']],
  // Breakfast
  ['McMuffin Bacon Œuf',           'breakfast',367,18, 30, 19, ['breakfast','cheese']],
  ['McMuffin Œuf Saucisse',        'breakfast',427,21, 28, 26, ['breakfast']],
  ['McMuffin Bacon',               'breakfast',310,15, 28, 14, ['breakfast']],
  ['Pancake (1)',                  'breakfast',105, 3, 17, 3,  ['breakfast']],
