...
const RUNNING_CITIES = {
  Lebanon: {
    ...
    trails: [
      ...
      // northern coast → Ain el-Mreisseh → Zaitunay Bay → Beirut Marina (NE)
      // Latitudes capped at ~33.9025 along the northern stretch (actual coast caps there)
      [
        // South end: Ramlet el-Bayda
        [33.8810, 35.4750], [33.8830, 35.4732], [33.8850, 35.4720], [33.8870, 35.4712], [33.8890, 35.4710],
        [33.8910, 35.4710],
        // Raouche / Pigeon Rocks viewpoint
        [33.8925, 35.4712], [33.8938, 35.4715], [33.8948, 35.4720],
        // Western Corniche climbing N
        [33.8960, 35.4730], [33.8972, 35.4742], [33.8983, 35.4755], [33.8993, 35.4768], [33.9002, 35.4780],
        [33.9010, 35.4792],
        // Manara area, peninsula's NW edge (cap at ~33.9023)
        [33.9015, 35.4805], [33.9018, 35.4820], [33.9020, 35.4838], [33.9021, 35.4858],
        // Northern coast heading E (stay flat ~33.9018-33.9020)
        [33.9020, 35.4880], [33.9018, 35.4900],
        // Ain el-Mreisseh
        [33.9015, 35.4922], [33.9013, 35.4945], [33.9012, 35.4968], [33.9013, 35.4990],
        // Zaitunay Bay → Beirut Marina
        [33.9018, 35.5012], [33.9025, 35.5035], [33.9032, 35.5055], [33.9038, 35.5075], [33.9043, 35.5095],
        [33.9047, 35.5115]
      ]
    ]
  },
