...
async function getSuggestions({ calorieTarget, proteinTarget, mealType, country = 'France', dietary = 'none', brand = '', excludeIds = [] }) {
  ...
  const fastFoodChains = ["McDonald's", "Burger King", "KFC", "Subway", "100 Montaditos", "Goiko", "Chick-fil-A", "Chipotle", "Panda Express", "7-Eleven", "Quick", "O'Tacos", "Chicken Street", "Peppe Chicken", "Five Guys", "Telepizza", "Cava", "Dip n Dip", "Pinkberry", "In-N-Out", "Shake Shack", "Wendy's", "Rodilla", "Malak Al Tawouk", "CheeseOnTop"];
